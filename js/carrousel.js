...
class Slider{
	constructor(selector, movimiento=true){
		//Asigna el valor de this
		this.move = this.move.bind(this);
		this.moveByButton = this.moveByButton.bind(this);		
		this.slider = document.querySelector(selector);
		this.itemsCount = this.slider.querySelectorAll(".img-container > *").length;
		this.interval = null;
	...
	move(){
		//Selecciona todos los hijos directos
	...
	moveTo(index){
		...
		this.slider.querySelector(".img-container").style.left = "-"+ left + "%";
	}
}
